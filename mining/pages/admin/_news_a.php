<div class="silver-bk justify-content-center">
  <div class="row justify-content-center">
    <div class="col-8 justify-content-center">
      <div class="indexx">
        <span>Новости игры</span>
      </div>
    </div>
    <div class="col-11 justify-content-center inde"> 	

<center><a href = "/?menu=mo4cloud&sel=news" class="stn">Список новостей</a> || <a href = "/?menu=mo4cloud&sel=news&add" class="stn">Добавить новость</a></center>
<BR />
...
if(isset($_GET["add"])){
	...
	$text = $_POST["ntext"];
		...
		if(mb_strlen($title) >= 3){
			...
			$db->Query("UPDATE db_users_a SET news_view = '1' ");
...
<center><input type="submit" name="newsadd" value="Сохранить" /></center>
</form>
</div></div></div></div>
<div class="clr"></div>	
<?PHP
...
<?PHP
    ...
    <td align="center"><a href="/?menu=mo4cloud&sel=news&edit=<?=$data["id"]; ?>" class="stn"><?=$data["title"]; ?></a></td>
