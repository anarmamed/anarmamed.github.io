...
(function (factory) {
    ...
    var defaults = {
        ...
        height: 32,              // height of a digit area
    ...
    var dictionary = {
        ...
        ru: { days: 'РґРЅРµР№',   hours: 'С‡Р°СЃРѕРІ',  min: 'РјРёРЅСѓС‚',    sec: 'СЃРµРєСѓРЅРґ' },
        ua: { days: 'РґРЅiРІ',   hours: 'РіРѕРґРёРЅ',  min: 'С…РІРёР»РёРЅ',   sec: 'СЃРµРєСѓРЅРґ' },
        de: { days: 'Tag',    hours: 'Uhr',    min: 'Minuten',  sec: 'Secunden' },
        fr: { days: 'jours',  hours: 'heures', min: 'minutes',  sec: 'secondes' },
        sp: { days: 'dГ­as',   hours: 'horas',  min: 'minutos',  sec: 'segundos' },
        it: { days: 'giorni', hours: 'ore',    min: 'minuti',   sec: 'secondi' },
        nl: { days: 'dagen',  hours: 'uren',   min: 'minuten',  sec: 'seconden' },
        no: { days: 'dager',  hours: 'timer',  min: 'minutter', sec: 'sekunder' },
        pt: { days: 'dias',   hours: 'horas',  min: 'minutos',  sec: 'segundos' },
        tr: { days: 'gГјn',    hours: 'saat',   min: 'dakika',   sec: 'saniye' },
